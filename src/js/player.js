class Player {
  iconPlay = `<svg xmlns="http://www.w3.org/2000/svg" height="160" width="160" viewBox="0 -960 960 960"  fill="currentColor">
        <path d="M320-200v-560l440 280-440 280Z"/>
      </svg>`;
  iconPause = `<svg width="90" height="90" viewBox="-1 0 8 8" xmlns="http://www.w3.org/2000/svg"  fill="currentColor">
